...
<a href="#" id="open_drawer_card" class="card bg-body-white hoverable card-xl-stretch mb-xl-8">
    <!--begin::Body-->
    <div class="card-body">
...
<!--end::Statistics Widget 5-->
    ...
    <div class="col-xl-4">
<!--layout-partial:partials/widgets-2/statistics/_widget-5.html-->
<!--begin::Statistics Widget 5-->
...
<div class="row g-5 g-xl-8">
    <!--begin::Col-->
    <div class="col-xl-4">
<!--layout-partial:partials/widgets-2/lists/_widget-1.html-->
<!--begin::List Widget 1-->
...
<!--begin::Menu 1-->
<div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_6678ff431b68c">
    <!--begin::Header-->
    <div class="px-7 py-5">
    ...
    <div class="px-7 py-5">
        ...
        <div class="mb-10">
            ...
            <!--begin::Input-->
            <div>
                <select class="form-select form-select-solid" multiple data-kt-select2="true" data-close-on-select="false" data-placeholder="Select option" data-dropdown-parent="#kt_menu_6678ff431b68c" data-allow-clear="true">
                    <option></option>
...
<div class="row g-5 g-xl-8">
    <div class="col-xl-4">
<!--layout-partial:partials/widgets-2/lists/_widget-3.html-->
<!--begin::List Widget 3-->
<div class="card card-xl-stretch mb-xl-8">
    <!--begin::Header-->
...
<!--end:List Widget 3-->
    ...
    <div class="col-xl-8">
<!--layout-partial:partials/widgets-2/charts/_widget-1.html-->
    ...
    <div class="card-header border-0 pt-5">
        ...
        <div class="card-toolbar">
            ...
            <button type="button" class="btn btn-sm btn-icon btn-color-primary btn-active-light-primary" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">
                <i class="ki-duotone ki-category fs-6"><span class="path1"></span><span class="path2"></span><span class="path3"></span><span class="path4"></span></i>            </button>
<!--begin::Menu 1-->
<div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_6678ff431b91f">
    <!--begin::Header-->
    <div class="px-7 py-5">
        <div class="fs-5 text-gray-900 fw-bold">Filter Options</div>
    </div>
    ...
    <div class="px-7 py-5">
        ...
        <div class="mb-10">
            ...
            <!--begin::Input-->
            <div>
                <select class="form-select form-select-solid" multiple data-kt-select2="true" data-close-on-select="false" data-placeholder="Select option" data-dropdown-parent="#kt_menu_6678ff431b91f" data-allow-clear="true">
                    <option></option>
                    <option value="1">Approved</option>
                    <option value="2">Pending</option>
                    <option value="2">In Process</option>
...
<div class="row g-5 g-xl-8">
    <div class="col-xl-6">
<!--layout-partial:partials/widgets-2/lists/_widget-7.html-->
<!--begin::List Widget 7-->
<div class="card card-xl-stretch mb-xl-8">
    <!--begin::Header-->
...
<!--begin::Menu 1-->
<div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_6678ff431b9a0">
    <!--begin::Header-->
    <div class="px-7 py-5">
        <div class="fs-5 text-gray-900 fw-bold">Filter Options</div>
    </div>
    ...
    <div class="px-7 py-5">
        ...
        <div class="mb-10">
            ...
            <!--begin::Input-->
            <div>
                <select class="form-select form-select-solid" multiple data-kt-select2="true" data-close-on-select="false" data-placeholder="Select option" data-dropdown-parent="#kt_menu_6678ff431b9a0" data-allow-clear="true">
                    <option></option>
                    <option value="1">Approved</option>
                    <option value="2">Pending</option>
                    <option value="2">In Process</option>
...
<!--end::List Widget 7-->
    ...
    <div class="col-xl-6">
<!--layout-partial:partials/widgets-2/lists/_widget-6.html-->
<!--begin::List Widget 6-->
<div class="card card-xl-stretch mb-5 mb-xl-8">
    <!--begin::Header-->
    <div class="card-header border-0">
