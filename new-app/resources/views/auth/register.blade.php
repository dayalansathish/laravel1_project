        ...
        <div class="d-flex flex-column flex-lg-row-fluid w-lg-50 p-10 order-2 order-lg-1">
            <div class="d-flex flex-center flex-column flex-lg-row-fluid">
                <div class="w-lg-500px p-10">
                    <form class="form w-100" novalidate="novalidate" id="kt_sign_up_form" data-kt-redirect-url="{{route('dashboard')}}" action="{{ route('account.registerProcess') }}" method="POST">
                        @csrf
                        ...
                        <div class="text-gray-500 text-center fw-semibold fs-6">
                            ...
                            <a href="{{ route('account.login') }}" class="link-primary fw-semibold">Sign in</a>
                        </div>
                    </form>
                </div>
            </div>
